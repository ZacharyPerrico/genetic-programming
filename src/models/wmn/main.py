...
# kwargs = {
#     'name': 'project_0',  # Name of folder to contain all results
#     'seed': None,
#     'verbose': True,
#     'parallelize': True,
...
#     'num_clients': 100,
#     'min_value':  0,  # Min value of a position (inclusive)
#     'max_value': 2000,  # Max value of a position (exclusive)
#     'radius': 200,  # Coverage radius of each router
#     ## Setup ##
#     'setup_func': setup_uniform_clients,  # Function that runs for each unique job and returns updated kwargs
#     ## Initialization ##
#     'init_individual_func': random_uniform_router_coords,  # Function used to generate a new organism
...
# kwargs = {
#     'name': 'standard_0',  # Name of folder to contain all results
#     'seed': None,
#     'verbose': True,
#     'parallelize': True,
#     'saves_path': '../../../saves/placement/',  # Save path relative to this file
...
#     'test_kwargs': [
#         ['Crossover Function', 'crossover_funcs'],
#         ['Two Point', [[coords_fixed_two_point_crossover, 0.8]]],
#         ['Reordered', [[coords_reorder_crossover, 0.8]]],
#     ]
# }

kwargs = {
    'name': 'default_1',  # Name of folder to contain all results
    'seed': None,
    'verbose': True,
    'parallelize': True,
    'saves_path': '../../../saves/placement/',  # Save path relative to this file
